...
@section('body')
            ...
            <div class="row">
                <div class="col-xl-12 bh-mb">
                    <div class="breadcrumb-holder">
                        <h1 class="main-title float-left">Store Listing</h1>
                        {{--                        <ol class="breadcrumb float-right">--}}
                        {{--                            <li class="breadcrumb-item">Home</li>--}}
                        {{--                            <li class="breadcrumb-item active">Language Listing</li>--}}
                        {{--                        </ol>--}}
                        <div class="float-right">
                            <a href="{{route('storeCreate')}}">
                                ...
                                <table class="table table-bordered" id="data_table">
                                    ...
                                    @foreach($data as $store)
                                        <tr>
                                            ...
                                            <td>{{$store->storeName->title}}</td>
                                            <td>


                                                <a title="Edit" href="{{route('storeEdit',['id'=>$store->id])}}"
                                                   class="btn btn-primary btn-sm"><i class="fas fa-pencil-alt"></i></a>

                                                <a title="Delete" data-id="{{$store->id}}"
    ...
    @include('admin.store.modal.delete_modal')
