...
@section('body')
            ...
            <div class="row">
                <div class="col-xl-12 bh-mb">
                    <div class="breadcrumb-holder">
                        <h1 class="main-title float-left">  Media Kit Record Listing</h1>
                        {{--                        <ol class="breadcrumb float-right">--}}
                        {{--                            <li class="breadcrumb-item">Home</li>--}}
                        {{--                            <li class="breadcrumb-item active">Language Listing</li>--}}
                        {{--                        </ol>--}}
                        <div class="float-right">
                            <a href="{{route('pressRecordCreate')}}">
                                    ...
                                    @foreach($data as $collection)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a title="Edit" href="{{route('pressRecordEdit',['id'=>$collection->id])}}"
    ...
    @include('admin.press_record.modal.delete_modal')
