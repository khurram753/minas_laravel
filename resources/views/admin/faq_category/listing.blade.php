...
@section('body')
            ...
            <div class="row">
                <div class="col-xl-12 bh-mb">
                    <div class="breadcrumb-holder">
                        <h1 class="main-title float-left">FAQ Category Listing</h1>
                        {{--                        <ol class="breadcrumb float-right">--}}
                        {{--                            <li class="breadcrumb-item">Home</li>--}}
                        {{--                            <li class="breadcrumb-item active">Language Listing</li>--}}
                        {{--                        </ol>--}}
                        <div class="float-right">
                            <a href="{{route('faqCategoryCreate')}}">
                                <button class="btn btn-primary">Create New FAQ Category</button>
                            </a>
                        </div>
                                    ...
                                    @foreach($data as $category)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a title="Edit" href="{{route('faqCategoryEdit',['id'=>$category->id])}}"
    ...
    @include('admin.faq_category.modal.delete_modal')
