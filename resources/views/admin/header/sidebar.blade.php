            ...
            <ul>
                ...
                <li class="submenu">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="{{route('mainPageEdit')}}">Main Page Image and Text</a></li>
...
{{--                        <li><a href="{{route('contactUsCreate')}}">Create</a></li>--}}
                ...
                <li class="submenu">
                    <a
                        @if(Request()->route()->getName() == 'faqListing' ||
                            Request()->route()->getName() == 'faqCreate')
                        class="active"
                        @endif
                        href="javascript:void(0)">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="{{route('faqListing')}}">Listing</a></li>
                        <li><a href="{{route('faqCreate')}}">Create New FAQ </a></li>
                    </ul>
                </li>
