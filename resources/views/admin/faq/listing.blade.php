...
@section('body')
            ...
            <div class="row">
                <div class="col-xl-12 bh-mb">
                    <div class="breadcrumb-holder">
                        <h1 class="main-title float-left">FAQ Listing</h1>
                        {{--                        <ol class="breadcrumb float-right">--}}
                        {{--                            <li class="breadcrumb-item">Home</li>--}}
                        {{--                            <li class="breadcrumb-item active">Language Listing</li>--}}
                        {{--                        </ol>--}}
                        <div class="float-right">
                            <a href="{{route('faqCreate')}}">
                                    ...
                                    @foreach($data as $faq)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a title="Edit" href="{{route('faqEdit',['id'=>$faq->id])}}"
                                                   class="btn btn-primary btn-sm"><i class="fas fa-pencil-alt"></i></a>

                                                <a title="Delete" data-id="{{$faq->id}}"
    ...
    @include('admin.faq.modal.delete_modal')
