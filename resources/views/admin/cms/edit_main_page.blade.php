            ...
            <div class="row">
                <div class="col-xl-12 bh-mb">
                    <div class="breadcrumb-holder">
                        <h1 class="main-title float-left"> Edit Main Page</h1>
                        <ol class="breadcrumb float-right">
                            <li class="breadcrumb-item">Home</li>
                            <li class="breadcrumb-item active"> Edit Main Page</li>
                        </ol>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <div class="form-group">
                            <label for="exampleInputEmail1">First Text</label>
                            <input type="text" class="form-control" name="first_text"
                                   placeholder="Enter First Text"
                                   maxlength="50" value="{{$data->first_text}}">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputEmail1">First Text Short Description</label>
                            <input type="text" class="form-control" name="first_short_description"
                                   placeholder="Enter First Text Short Description"
                                   maxlength="50" value="{{$data->first_short_description}}">
                        </div>


                        <div class="form-group">
                            <label for="exampleInputEmail1">Second Text</label>
                            <input type="text" class="form-control" name="second_text"
                                   placeholder="Enter Second Text"
                                   maxlength="50" value="{{$data->second_text}}">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputEmail1">Second Text Short Description</label>
                            <input type="text" class="form-control" name="second_short_description"
                                   placeholder="Enter Second Text Short Description"
                                   maxlength="50" value="{{$data->second_short_description}}">
                        </div>
