<footer id="footer" class="relative footer z-30 overflow">
    ...
    <div class="over grid max-12cols-g trans mobile-hor-100">
        <div class="gutter mobile-hor-gutter">
            <div
                class="font-70 font-thin color-white pt-139 maxw-480  m-left-auto a-right mb-12 opc-0 no-visible mobile-hor-left mobile-hor-ml-0 mobile-pt-48 js-fade-left skrollr-pointer skrollable skrollable-before"
            ...
            <div class="relative">
                ...
                <div
                    ...
                    <a href="eshop.html" arial-label="Minas studio shop"
                       class="link-line-white font-bold font-12 extra-ls">
                                 <span
                                     class="opc-0 no-visible js-fade-up relative skrollr-pointer display--block skrollable skrollable-before"
                                     data-delay=".15" data-emit-events="" data-bottom-top="" style="">
                                    SHOP ONLINE                                 </span>
                    </a>
                </div>
                <div class="social maxw-230 abs-tr block-100">
                    <div
                        ...
                        <div
                            class="opc-0 no-visible js-fade-left single-social skrollr-pointer skrollable skrollable-before"
                            ...
                            <a href="#" target="_blank" rel="nofollow noopener noreferrer"
                               class="social-link relative display--block font-light font-12 extra-ls color-grey-med">
                                        <span
                                            class="abs-lc left-7 icon-social-media icon icon--social-media-instagram"></span>
                        ...
                        <div
                            ...
                            <a href="#" target="_blank" rel="nofollow noopener noreferrer"
                               class="social-link relative display--block font-light font-12 extra-ls color-grey-med">
                                        <span
                                            class="abs-lc left-7 icon-social-media icon icon--social-media-vimeo"></span>
                        ...
                        <div
                            ...
                            <a href="#" target="_blank" rel="nofollow noopener noreferrer"
                               class="social-link relative display--block font-light font-12 extra-ls color-grey-med">
                                        <span
                                            class="abs-lc left-7 icon-social-media icon icon--social-media-facebook"></span>
            ...
            <div
                class="footer__copyrights  relative color-grey-med font-light font-12 opc-0 no-visible js-fade-up skrollr-pointer skrollable skrollable-before"
                ...
                <nav class="copyright-menu display--inline-top">
                    <ul id="menu-copyright_menu_en" class="menu-ul">
                        <li id="menu-item-393"
                            class="menu-item menu-item-type-post_type menu-item-object-page menu-item-393 main-item item--390 mnu-1">
                            <a href="#" class="menu-a menu-link item--390">TERMS &amp; CONDITIONS</a>
                        </li>
                        <li id="menu-item-394"
                        ...
                        <li id="menu-item-395"
                            class="menu-item menu-item-type-post_type menu-item-object-page menu-item-395 main-item item--3 mnu-3">
                            <a href="#" class="menu-a menu-link item--3">PRIVACY POLICY</a>
                        </li>
                    </ul>
                </nav>
