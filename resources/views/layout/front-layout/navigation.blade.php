<nav class="menu-holder  a-right z-700 fixed  maxw-1200 hidden-view" id="menu-holder">
    <div class="menu__bg fill-dimensions bg-dark-light  z-1 origin-r abs-tr fixed maxw-1200 scale-y"
         id="menu-holder__bg"></div>
    <span id="menu-close" class="menu-close cursor color-black abs-tr z-20 opc-0 js-menu-fade"></span>
                ...
                <a href="{{route('heritage')}}" class="link-underline menu-box-link">
                    ...
                    <div class="relative overflow">
                        <div class="js-scale-in--sm js-menu-scale opc-0">
                            ...
                            <img class="resp-image mb-22" src="/site/images/heritage_menu.jpg"
                                 alt="Minas Designs-the heritage">
                        </div>
                    </div>
            ...
            <div class="display--inline-top menu-box--holder  menu-box--right   a-left">
                <a href="{{route('shop')}}" class="link-underline menu-box-link">
                    ...
                    <div class="relative overflow">
                        <div class="js-scale-in--sm js-menu-scale opc-0">
                            <div class="fill-dimensions multiply bg-black opc-40 trans z-10"></div>
                            <img class="resp-image mb-22" src="/site/images/shop_menu.jpg"
                                 alt="Minas Designs-shop online">
                        </div>
                    </div>
                    <span class="display--block font-35 extra-lh font-light opc-0 js-menu-fade">
                        <span class="link-underline-text">
