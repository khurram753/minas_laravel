<aside class="ns-popup fill-dimensions fixed z-20" id="ns-popup-holder">
    ...
    <div class="over">
        ...
        {{--                    <input type="hidden" name="ref" id="page_url" value="eshop.minas-designs.com/"/>--}}
        ...
        {{--                                <label class="font-bold title-17 extra-ls extra-lh display--block" for="full_name">FULL--}}
        ...
        {{--                                       class="input  required email title-25 pb-50 extra-lh font-light" id="ns-email"--}}
        {{--                                       value="" required>--}}
        {{--                            </div>--}}
        {{--                        </div>--}}
        {{--                    </div>--}}
        ...
        {{--                                <input type="text" name="country" class="input title-25 extra-lh font-light pb-50"--}}
        {{--                                       id="country" value="">--}}
        {{--                            </div>--}}
        {{--                        </div>--}}
        {{--                    </div>--}}
        ...
        {{--                    <div class="ns-gdpr">--}}
        {{--                        <div class="gutter mobile-hor-gutter">--}}
        {{--                            <div class="font-light title-16 maxw-477 m-auto ns-policy pt-17"><p>Βy submitting your--}}
        {{--                                    request, you agree to the <a href="#">Privacy Policy</a> and <a href="#">Terms &amp;--}}
        {{--                                        Conditions</a>.</p>--}}
        {{--                            </div>--}}
        {{--                            <div class="mb-t">--}}
        ...
        {{--                                    <label class="chk-box trans abs-lc z-8 clickable mobile-abs-tl ns-accept-checkbox"--}}
        {{--                                           for="ns-accept">--}}
        {{--                                        <svg class="icon icon--check abs-tc sm">--}}
        {{--                                            <use xlink:href="#check"></use>--}}
        {{--                                        </svg>--}}
        {{--                                    </label>--}}
        {{--                                    <label class="chk-label pl-55 trans over font-bold title-12 extra-ls extra-lh3 color--black clickable ns-accept display--inline"--}}
        {{--                                           for="ns-accept">I AGREE WITH THE ABOVE TERMS</label>--}}
        {{--                                </div>--}}
        {{--                            </div>--}}
        {{--                            <div class="ns-reply-text form-reply trans-med font-bold title-17 extra-ls extra-lh uppercase"--}}
        {{--                                 id="ns-reply-text"></div>--}}
{{--                                    <span class="display--block">--}}
{{--                                        <span class="display--inline circle-link relative">--}}
{{--                                            <input type="button" class="submit-button op-0 z-5 fill-dimensions trans"--}}
{{--                                                   value="ΕΓΓΡΑΦΗ" id="ns-submit" data-reply="#ns-reply-text">--}}
{{--                                            <span class="btn-black display--block">--}}
{{--                                                <span class="circle-btn relative cursor display--inline circle-link " id="">    <svg--}}
                    ...
                    <div id="mc_embed_signup_scroll">
                        ...
                        <div id="mce-responses" class="clear">
                            <div class="response" id="mce-error-response"
                                 style="display:none;color: black;text-align: center;width: 100%;"></div>
                            <div class="response" id="mce-success-response"
                                 style="display:none;width: 100%;text-align: center;font-size: 30px;"></div>
                        </div>
                        <!-- real people should not fill this in and expect good things - do not remove this or risk form bot signups-->
                        <div style="position: absolute; left: -5000px;" aria-hidden="true">
                            <input type="text" name="b_58f1bd0f245587742ce65b32a_1302115311" tabindex="-1" value="">
                        </div>
                        ...
                        <div class="clear">
                            ...
                            <span class="display--block" style="text-align: center">
                                <span class="display--inline circle-link relative">
                                    <input type="submit" value="Subscribe" name="subscribe" id="mc-embedded-subscribe ns-submit"
                                           class="button submit-button op-0 z-30 fill-dimensions trans" style="width: 100%;height: 100%">
{{--                                    <input type="button" class="submit-button op-0 z-5 fill-dimensions trans"--}}
{{--                                           value="ΕΓΓΡΑΦΗ" id="ns-submit" data-reply="#ns-reply-text">--}}
                                    <span class="btn-black display--block">
        		...
        		c-2.123-9.098-8.54-15.85-14.888-22.307c-7.189-7.311-13.368-15.558-20.665-22.752C110.812,8.158,109.23,6.196,107.309,4.917z"/>
                                            ...
                                            <span class="abs-center a-center z-5 font-12 extra-ls extra-lh2 font-bold block-70">
                                                <span class="circle-btn__txt">SUBSCRIBE</span>
                                            </span>
                                        </span>
                                    </span>
                                </span>
