        ...
        <div class="gutter gutter_custom">
            ...
            <ul class="menu-primary menu-ul">
                ...
                <li class="main-item main-item menu-item menu-item-has-children menu-item--collections">
                    <a href="{{route('faq')}}">
                        <span class="menu-item-inner relative display--block">
                            <span class="menu-a uppercase">FAQ's</span>
                            <svg class="icon icon--arrow-small-right color--black abs-tr no-visible">
                                <use xlink:href="#arrow-small-right"></use>
                            </svg>
                        </span>
            ...
            @foreach($headerCategories as $key => $headerCategory)
                <div class="block-50 display--inline-top js-bring-in" style="float: left;">
                    ...
                    <span class="menu__banner-img display--block relative cover-img mb-c"
                          style="background-image: url('{{$headerCategory->image ?  asset($headerCategory->image):asset('site/images/pendants-1.jpg')}}')">
                        <span class="grad-bot-grey-light block-100 h-50 abs-bl z-1"></span>
                        <span class="circ current-c abs-bc br-50 mb-med"><span
                                class="block-100 abs-lc font-bold title-13 ls-180">Nº {{$key+1}}</span></span>
                    </span>
                        <span
                            class="menu__banner-title trans font-bold title-25 uppercase ls-30">{{$headerCategory->name}}</span>
