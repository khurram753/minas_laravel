...
namespace App\Services\Site\Registration;
...
//            }
    ...
    {
        return view('site.authentication.forgot_password');
    }
...
//                ->with(['openUpdatePasswordForm' => 'updatePasswordModal', 'email' => $data->email]);
            return view('site.authentication.update_password',compact('data'));
        } else {
            return redirect()->route('loginPageUser')
