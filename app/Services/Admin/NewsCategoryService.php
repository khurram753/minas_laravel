...
class NewsCategoryService
{
    public function index()
    {
        ...
        return view('admin.news_category.listing', compact('data'));
    }
    ...
    public function edit($id)
    {
        ...
        if($data)
        {
            return view('admin.news_category.edit',compact('data'));
        }
        else{
            return redirect()->route('newsCategoryListing')->with('error','Record Not Found');
        }
    }
