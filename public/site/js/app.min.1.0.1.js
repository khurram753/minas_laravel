!function (e) {
    ...
    function r(e) {
        if (void 0 === e.length) o(e, "click", t); else if ("string" != typeof e && !(e instanceof String)) for (var n = 0; n < e.length; n++) o(e[n], "click", t)
    }
    ...
    var i = -1 !== navigator.userAgent.indexOf("MSIE"), l = window.open;
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
    ...
    function O(t, e, i, s) {
        var r = {a: t}, n = {}, a = {}, o = {c: s}, l = (t + e) / 2, h = (e + i) / 2, _ = (i + s) / 2, u = (l + h) / 2,
            f = (h + _) / 2, c = (f - u) / 8;
    ...
    function v(t, e, i, s, r) {
        var n, a, o, l, h, _, u, f, c, p, d, m, g, y = t.length - 1, v = 0, T = t[0].a;
    ...
    function c(t, e, i, s, r, n) {
        var a, o, l, h, _, u, f, c, p = {}, d = [], m = n || t[0];
        ...
        if (!s) {
            for (a = d.length; -1 < --a;) if (g[o]) for (u = (l = p[d[a]]).length - 1, h = 0; h < u; h++) _ = l[h + 1].da / b[h] + l[h].da / x[h] || 0, P[h] = (P[h] || 0) + _ * _;
    ...
    function p(t, e, i) {
        for (var s, r, n, a, o, l, h, _, u, f, c, p = 1 / i, d = t.length; -1 < --d;) for (n = (f = t[d]).a, a = f.d - n, o = f.c - n, l = f.b - n, s = r = 0, _ = 1; _ <= i; _++) s = r - (r = ((h = p * _) * h * a + 3 * (u = 1 - h) * (h * o + u * l)) * h), e[c = d * i + _ - 1] = (e[c] || 0) + s * s
    }
    ...
    _gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function (s, _, y) {
        ...
        }, T = 1e-10, x = y._internals, b = x.isSelector, w = x.isArray, t = v.prototype = y.to({}, .1, {}), P = [];
        v.version = "1.20.3", t.constructor = v, t.kill()._gc = !1, v.killTweensOf = v.killDelayedCallsTo = y.killTweensOf, v.getTweensOf = y.getTweensOf, v.lagSmoothing = y.lagSmoothing, v.ticker = y.ticker, v.render = y.render, t.invalidate = function () {
            ...
            if (this._initted || r) if (e) this._initted = !1, r && this.render(0, !0, !0); else if (this._gc && this._enabled(!0, !1), this._notifyPluginsOfEnabled && this._firstPT && y._onPluginEvent("_onDisable", this), .998 < this._time / this._duration) {
                var n = this._totalTime;
                this.render(0, !0, !1), this._initted = !1, this.render(n, !0, !1)
            } else if (this._initted = !1, this._init(), 0 < this._time || r) for (var a, o = 1 / (1 - s), l = this._firstPT; l;) a = l.s + l.c, l.c *= o, l.s = a - l.c, l = l._next;
            return this
        }, t.render = function (t, e, i) {
            this._initted || 0 === this._duration && this.vars.repeat && this.invalidate();
            var s, r, n, a, o, l, h, _, u, f = this._dirty ? this.totalDuration() : this._totalDuration, c = this._time,
            ...
            var l, h, _, u, f = 0, c = [], p = i.cycle, d = i.startAt && i.startAt.cycle;
        ...
        v.killAll = function (t, e, i, s) {
            ...
            var r, n, a, o = u(0 != s), l = o.length, h = e && i && s;
            ...
            if (null != t) {
                ...
                if ("string" == typeof t && (t = y.selector(t) || t), b(t) && (t = m(t)), w(t)) for (n = t.length; -1 < --n;) v.killChildTweensOf(t[n], e); else {
                    for (r in i = [], o) for (s = o[r].target.parentNode; s;) s === t && (i = i.concat(o[r].tweens)), s = s.parentNode;
        ...
        return v.pauseAll = function (t, e, i) {
            ...
            var e = s._rootTimeline, i = y.ticker.time;
        ...
        var g = 1e-10, t = f._internals, e = c._internals = {}, y = t.isSelector, v = t.isArray, T = t.lazyTweens,
            x = t.lazyRender, a = _gsScope._gsDefine.globals, n = e.pauseCallback = function () {
            }, i = c.prototype = new u;
        return c.version = "1.20.3", i.constructor = c, i.kill()._gc = i._forcingPlayhead = i._hasPause = !1, i.to = function (t, e, i, s) {
            ...
            var i, s, r, n, a = new c(t), o = a._timeline;
            ...
            var r, n;
            if (s instanceof _ && s.timeline === this) this.remove(s); else if (s && (s instanceof Array || s.push && v(s))) for (n = s.length; -1 < --n;) s[n] instanceof _ && s[n].timeline === this && this.remove(s[n]);
            ...
            var s, r, n, a, o, l, h, _ = this._time, u = this._dirty ? this.totalDuration() : this._totalDuration,
                f = this._startTime, c = this._timeScale, p = this._paused;
            if (_ !== this._time && (t += this._time - _), u - 1e-7 <= t && 0 <= t) this._totalTime = this._time = u, this._reversed || this._hasPausedChild() || (r = !0, a = "onComplete", o = !!this._timeline.autoRemoveChildren, 0 === this._duration && (t <= 0 && -1e-7 <= t || this._rawPrevTime < 0 || this._rawPrevTime === g) && this._rawPrevTime !== t && this._first && (o = !0, this._rawPrevTime > g && (a = "onReverseComplete"))), this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t : g, t = u + 1e-4; else if (t < 1e-7) if (this._totalTime = this._time = 0, (0 !== _ || 0 === this._duration && this._rawPrevTime !== g && (0 < this._rawPrevTime || t < 0 && 0 <= this._rawPrevTime)) && (a = "onReverseComplete", r = this._reversed), t < 0) this._active = !1, this._timeline.autoRemoveChildren && this._reversed ? (o = r = !0, a = "onReverseComplete") : 0 <= this._rawPrevTime && this._first && (o = !0), this._rawPrevTime = t; else {
                if (this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t : g, 0 === t && r) for (s = this._first; s && 0 === s._startTime;) s._duration || (r = !1), s = s._next;
                t = 0, this._initted || (o = !0)
            } else {
                if (this._hasPause && !this._forcingPlayhead && !e) {
                    if (_ <= t) for (s = this._first; s && s._startTime <= t && !l;) s._duration || "isPause" !== s.data || s.ratio || 0 === s._startTime && 0 === this._rawPrevTime || (l = s), s = s._next; else for (s = this._last; s && s._startTime >= t && !l;) s._duration || "isPause" === s.data && 0 < s._rawPrevTime && (l = s), s = s._prev;
                    l && (this._time = t = l._startTime, this._totalTime = t + this._cycle * (this._totalDuration + this._repeatDelay))
                }
                this._totalTime = this._time = this._rawPrevTime = t
            }
            if (this._time !== _ && this._first || i || o || l) {
                if (this._initted || (this._initted = !0), this._active || !this._paused && this._time !== _ && 0 < t && (this._active = !0), 0 === _ && this.vars.onStart && (0 === this._time && this._duration || e || this._callback("onStart")), _ <= (h = this._time)) for (s = this._first; s && (n = s._next, h === this._time && (!this._paused || p));) (s._active || s._startTime <= h && !s._paused && !s._gc) && (l === s && this.pause(), s._reversed ? s.render((s._dirty ? s.totalDuration() : s._totalDuration) - (t - s._startTime) * s._timeScale, e, i) : s.render((t - s._startTime) * s._timeScale, e, i)), s = n; else for (s = this._last; s && (n = s._prev, h === this._time && (!this._paused || p));) {
        ...
        var S = 1e-10, s = o._internals, k = s.lazyTweens, R = s.lazyRender, l = _gsScope._gsDefine.globals,
            h = new t(null, null, 1, 0), r = i.prototype = new e;
        return r.constructor = i, r.kill()._gc = !1, i.version = "1.20.3", r.invalidate = function () {
            ...
            this._gc && this._enabled(!0, !1);
            var s, r, n, a, o, l, h, _, u = this._time, f = this._dirty ? this.totalDuration() : this._totalDuration,
                c = this._duration, p = this._totalTime, d = this._startTime, m = this._timeScale,
                g = this._rawPrevTime, y = this._paused, v = this._cycle;
            if (u !== this._time && (t += this._time - u), f - 1e-7 <= t && 0 <= t) this._locked || (this._totalTime = f, this._cycle = this._repeat), this._reversed || this._hasPausedChild() || (r = !0, a = "onComplete", o = !!this._timeline.autoRemoveChildren, 0 === this._duration && (t <= 0 && -1e-7 <= t || g < 0 || g === S) && g !== t && this._first && (o = !0, S < g && (a = "onReverseComplete"))), this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t : S, this._yoyo && 0 != (1 & this._cycle) ? this._time = t = 0 : t = (this._time = c) + 1e-4; else if (t < 1e-7) if (this._locked || (this._totalTime = this._cycle = 0), ((this._time = 0) !== u || 0 === c && g !== S && (0 < g || t < 0 && 0 <= g) && !this._locked) && (a = "onReverseComplete", r = this._reversed), t < 0) this._active = !1, this._timeline.autoRemoveChildren && this._reversed ? (o = r = !0, a = "onReverseComplete") : 0 <= g && this._first && (o = !0), this._rawPrevTime = t; else {
                if (this._rawPrevTime = c || !e || t || this._rawPrevTime === t ? t : S, 0 === t && r) for (s = this._first; s && 0 === s._startTime;) s._duration || (r = !1), s = s._next;
                t = 0, this._initted || (o = !0)
                ...
                if (u <= (t = this._time) || this._repeat && v !== this._cycle) for (s = this._first; s && s._startTime <= t && !h;) s._duration || "isPause" !== s.data || s.ratio || 0 === s._startTime && 0 === this._rawPrevTime || (h = s), s = s._next; else for (s = this._last; s && s._startTime >= t && !h;) s._duration || "isPause" === s.data && 0 < s._rawPrevTime && (h = s), s = s._prev;
            ...
            if (this._cycle !== v && !this._locked) {
                var T = this._yoyo && 0 != (1 & v), x = T === (this._yoyo && 0 != (1 & this._cycle)),
                    b = this._totalTime, w = this._cycle, P = this._rawPrevTime, O = this._time;
            ...
            if (this._time !== u && this._first || i || o || h) {
                if (this._initted || (this._initted = !0), this._active || !this._paused && this._totalTime !== p && 0 < t && (this._active = !0), 0 === p && this.vars.onStart && (0 === this._totalTime && this._totalDuration || e || this._callback("onStart")), u <= (_ = this._time)) for (s = this._first; s && (n = s._next, _ === this._time && (!this._paused || y));) (s._active || s._startTime <= this._time && !s._paused && !s._gc) && (h === s && this.pause(), s._reversed ? s.render((s._dirty ? s.totalDuration() : s._totalDuration) - (t - s._startTime) * s._timeScale, e, i) : s.render((t - s._startTime) * s._timeScale, e, i)), s = n; else for (s = this._last; s && (n = s._prev, _ === this._time && (!this._paused || y));) {
        ...
        init: function (t, e, i) {
            ...
            for (s in this._autoRotate = u ? u instanceof Array ? u : [["x", "y", "rotation", !0 === u ? 0 : Number(u) || 0]] : null, _) this._props.push(s);
            ...
            if (this._beziers = "cubic" !== e.type && "quadratic" !== e.type && "soft" !== e.type ? c(l, isNaN(e.curviness) ? 1 : e.curviness, !1, "thruBasic" === e.type, e.correlate, o) : function (t, e, i) {
                var s, r, n, a, o, l, h, _, u, f, c, p = {}, d = "cubic" === (e = e || "soft") ? 3 : 2,
                    m = "soft" === e, g = [];
            ...
            if (u = this._autoRotate) for (this._initialRotations = [], u[0] instanceof Array || (this._autoRotate = u = [u]), n = u.length; -1 < --n;) {
        ...
        set: function (t) {
            var e, i, s, r, n, a, o, l, h, _, u = this._segCount, f = this._func, c = this._target,
        ...
        if (t) {
            ...
            e._registerComplexSpecialProp("bezier", {
                parser: function (t, e, i, s, r, n) {
                    ...
                    var a, o, l, h = e.values, _ = h.length - 1, u = [], f = {};
                    if (_ < 0) return r;
                    for (a = 0; a <= _; a++) l = c(t, h[a], s, r, n, _ !== a), u[a] = l.end;
                    for (o in e) f[o] = e[o];
                    return f.values = u, (r = new d(t, "bezier", 0, 0, l.pt, 2)).data = l, r.plugin = n, r.setRatio = p, 0 === f.autoRotate && (f.autoRotate = !0), !f.autoRotate || f.autoRotate instanceof Array || (a = !0 === f.autoRotate ? 0 : Number(f.autoRotate), f.autoRotate = null != l.end.left ? [["left", "top", "rotation", a, !1]] : null != l.end.x && [["x", "y", "rotation", a, !1]]), f.autoRotate && (s._transform || s._enableTransforms(!1), l.autoRotate = s._target._gsTransform, l.proxy.rotation = l.autoRotate.rotation || 0, s._overwriteProps.push("rotation")), n._onInitTween(l.proxy, f, s._tween), r
                }
            })
        }
    }, s._mod = function (t) {
        ...
        }, h = _gsScope._gsDefine.globals, m = {}, t = Y.prototype = new n("css");
        ...
        function y(t, e) {
            var i, s, r, n = {};
            if (e = e || lt(t, null)) if (i = e.length) for (; -1 < --i;) -1 !== (r = e[i]).indexOf("-transform") && Nt !== r || (n[r.replace(V, a)] = e.getPropertyValue(r)); else for (i in e) -1 !== i.indexOf("Transform") && Xt !== i || (n[i] = e[i]); else if (e = t.currentStyle || t.style) for (i in e) "string" == typeof i && void 0 === n[i] && (n[i.replace(V, a)] = e[i]);
        ...
        function T(t, e, i) {
            ...
            var s = parseFloat("width" === e ? t.offsetWidth : t.offsetHeight), r = ft[e], n = r.length;
        ...
        var C, x, b, j, w, D, M, F, e, i, z = /(?:\-|\.|\b)(\d|\.|e\-)+/g,
            E = /(?:\d|\-\d|\.\d|\-\.\d|\+=\d|\-=\d|\+=.\d|\-=\.\d)+/g,
            I = /(?:\+=|\-=|\-|\b)[\d\-\.]+[a-zA-Z0-9]*(?:%|\b)/gi, _ = /(?![+-]?\d*\.?\d+|[+-]|e[+-]\d+)[^0-9]/g,
            X = /(?:\d|\-|\+|=|#|\.)*/g, N = /opacity *= *([^)]*)/i, L = /opacity:([^;]*)/i,
            u = /alpha\(opacity *=.+?\)/i, U = /^(rgb|hsl)/, f = /([A-Z])/g, V = /-([a-z])/gi,
            q = /(^(?:url\(\"|url\())|(?:(\"\))$|\)$)/gi, W = /(?:Left|Right|Width)/i,
            G = /(M11|M12|M21|M22)=[\d\-\.e]+/gi, Z = /progid\:DXImageTransform\.Microsoft\.Matrix\(.+?\)/i,
            H = /,(?=[^\)]*(?:\(|$))/gi, $ = /[\s,\(]/i, Q = Math.PI / 180, K = 180 / Math.PI, J = {}, r = {style: {}},
            tt = _gsScope.document || {
                createElement: function () {
                    return r
                }
            }, et = o("div"), it = o("img"), st = Y._internals = {_specialProps: m},
            ...
            at = "", ot = "", lt = tt.defaultView ? tt.defaultView.getComputedStyle : function () {
                ...
                var n, a, o, l = W.test(e), h = t, _ = et.style, u = i < 0, f = 1 === i;
                if (u && (i = -i), f && (i *= 100), "lineHeight" !== e || s) if ("%" === s && -1 !== e.indexOf("border")) n = i / 100 * (l ? t.clientWidth : t.clientHeight); else {
                    if (_.cssText = "border:0 solid red;position:" + ht(t, "position") + ";line-height:0;", "%" !== s && h.appendChild && "v" !== s.charAt(0) && "rem" !== s) _[l ? "borderLeftWidth" : "borderTopWidth"] = i + s; else {
                ...
                var s = "left" === e ? "Left" : "Top", r = ht(t, "margin" + s, i);
                return t["offset" + s] - (_t(t, e, parseFloat(r), r.replace(X, "")) || 0)
            }, ft = {width: ["Left", "Right"], height: ["Top", "Bottom"]},
            ct = ["marginLeft", "marginRight", "marginTop", "marginBottom"], pt = function (t, e) {
                ...
                if (t) if ("number" == typeof t) i = [t >> 16, t >> 8 & 255, 255 & t]; else {
                    if ("," === t.charAt(t.length - 1) && (t = t.substr(0, t.length - 1)), dt[t]) i = dt[t]; else if ("#" === t.charAt(0)) 4 === t.length && (t = "#" + (s = t.charAt(1)) + s + (r = t.charAt(2)) + r + (n = t.charAt(3)) + n), i = [(t = parseInt(t.substr(1), 16)) >> 16, t >> 8 & 255, 255 & t]; else if ("hsl" === t.substr(0, 3)) if (i = f = t.match(z), e) {
                        if (-1 !== t.indexOf("=")) return t.match(E)
                    } else a = Number(i[0]) % 360 / 360, o = Number(i[1]) / 100, s = 2 * (l = Number(i[2]) / 100) - (r = l <= .5 ? l * (o + 1) : l + o - l * o), 3 < i.length && (i[3] = Number(i[3])), i[0] = c(a + 1 / 3, s, r), i[1] = c(a, s, r), i[2] = c(a - 1 / 3, s, r); else i = t.match(z) || dt.transparent;
        ...
        function yt(t, e, n, a) {
            ...
            var o, l = e ? (t.match(gt) || [""])[0] : "", h = t.split(l).join("").match(I) || [],
                _ = t.substr(0, t.indexOf(h[0])), u = ")" === t.charAt(t.length - 1) ? ")" : "",
                f = -1 !== t.indexOf(" ") ? " " : ",", c = h.length, p = 0 < c ? h[0].replace(z, "") : "";
            return c ? o = e ? function (t) {
                var e, i, s, r;
                if ("number" == typeof t) t += p; else if (a && H.test(t)) {
                    for (r = t.replace(H, "|").split("|"), s = 0; s < r.length; s++) r[s] = o(r[s]);
                    return r.join(",")
                }
                if (e = (t.match(gt) || [l])[0], s = (i = t.split(e).join("").match(I) || []).length, c > s--) for (; ++s < c;) i[s] = n ? i[(s - 1) / 2 | 0] : h[s];
                ...
                if (s = (e = t.match(I) || []).length, c > s--) for (; ++s < c;) e[s] = n ? e[(s - 1) / 2 | 0] : h[s];
                return _ + e.join(f) + u
            } : function (t) {
                return t
            }
        ...
        function vt(h) {
            return h = h.split(","), function (t, e, i, s, r, n, a) {
                var o, l = (e + "").split(" ");
        ...
        var xt = (st._setPluginRatio = function (t) {
            ...
            var a, o, l, h, _, u = s, f = {}, c = {}, p = i._transform, d = J;
            for (i._transform = null, J = e, s = _ = i.parse(t, e, s, r), J = d, n && (i._transform = p, u && (u._prev = null, u._prev && (u._prev._next = null))); s && s !== u;) {
                if (s.type <= 1 && (c[o = s.p] = s.s + s.c, f[o] = s.s, n || (h = new xt(s, "s", o, h, s.r), s.c = 0), 1 === s.type)) for (a = s.l; 0 < --a;) l = "xn" + a, c[o = s.p + "_" + l] = s.data[l], f[o] = s[l], n || (h = new xt(s, l, o, h, s.rxp[l]));
                s = s._next
            }
        ...
        function Rt(t, e, i) {
            var s, r = tt.createElementNS("http://www.w3.org/2000/svg", t), n = /([a-z])([A-Z])/g;
            for (s in i) r.setAttributeNS(null, s.replace(n, "$1-$2").toLowerCase(), i[s]);
            return e.appendChild(r), r
        }

        function At(t, e, i, s, r, n) {
            var a, o, l, h, _, u, f, c, p, d, m, g, y, v, T = t._gsTransform, x = Zt(t, !0);
        ...
        function Ct(t) {
            var e, i, s = this.data, r = -s.rotation * Q, n = r + s.skewX * Q, a = 1e5,
            ...
            if (f) {
                ...
                var c, p, d = this.t.offsetWidth, m = this.t.offsetHeight, g = "absolute" !== f.position,
                    ...
                    v = s.x + d * s.xPercent / 100, T = s.y + m * s.yPercent / 100;
        ...
        var Dt, Mt, Ft, zt, Et,
            ...
            Xt = O("transform"), Nt = at + "transform", Lt = O("transformOrigin"), Bt = null !== O("perspective"),
            ...
            }, jt = _gsScope.SVGElement, Ut = tt.documentElement || {},
            ...
            qt = function (t) {
                ...
                var i, s, r, n, a, o, l = t._gsTransform || new Yt, h = t.style;
                ...
                var r, n, a, o, l, h, _ = i && t._gsTransform || new Yt, u = _.scaleX < 0,
                ...
                if (_.svg = !(!t.getCTM || !Wt(t)), _.svg && (At(t, ht(t, Lt, e, !1, "50% 50%") + "", _, t.getAttribute("data-svg-origin")), Dt = Y.useSVGTransformAttr || Vt), (r = Zt(t)) !== Gt) {
                    if (16 === r.length) {
                        var p, d, m, g, y, v = r[0], T = r[1], x = r[2], b = r[3], w = r[4], P = r[5], O = r[6], S = r[7],
                            k = r[8], R = r[9], A = r[10], C = r[12], D = r[13], M = r[14], F = r[11], z = Math.atan2(O, A);
                        ...
                        var E = 6 <= r.length, I = E ? r[0] : 1, X = r[1] || 0, N = r[2] || 0, L = E ? r[3] : 1;
                ...
                var e, i, s, r, n, a, o, l, h, _, u, f, c, p, d, m, g, y, v, T, x, b, w, P = this.data, O = this.t.style,
                    S = P.rotation, k = P.rotationX, R = P.rotationY, A = P.scaleX, C = P.scaleY, D = P.scaleZ, M = P.x,
                    F = P.y, z = P.z, E = P.svg, I = P.perspective, X = P.force3D, N = P.skewY, L = P.skewX;
                if (N && (L += N, S += N), !((1 !== t && 0 !== t || "auto" !== X || this.tween._totalTime !== this.tween._totalDuration && this.tween._totalTime) && X || z || I || R || k || 1 !== D) || Dt && E || !Bt) S || L || E ? (S *= Q, b = L * Q, w = 1e5, i = Math.cos(S) * A, n = Math.sin(S) * A, s = Math.sin(S - b) * -C, a = Math.cos(S - b) * C, b && "simple" === P.skewType && (e = Math.tan(b - N * Q), s *= e = Math.sqrt(1 + e * e), a *= e, N && (e = Math.tan(N * Q), i *= e = Math.sqrt(1 + e * e), n *= e)), E && (M += P.xOrigin - (P.xOrigin * i + P.yOrigin * s) + P.xOffset, F += P.yOrigin - (P.xOrigin * n + P.yOrigin * a) + P.yOffset, Dt && (P.xPercent || P.yPercent) && (d = this.t.getBBox(), M += .01 * P.xPercent * d.width, F += .01 * P.yPercent * d.height), M < (d = 1e-6) && -d < M && (M = 0), F < d && -d < F && (F = 0)), v = (i * w | 0) / w + "," + (n * w | 0) / w + "," + (s * w | 0) / w + "," + (a * w | 0) / w + "," + M + "," + F + ")", E && Dt ? this.t.setAttribute("transform", "matrix(" + v) : O[Xt] = (P.xPercent || P.yPercent ? "translate(" + P.xPercent + "%," + P.yPercent + "%) matrix(" : "matrix(") + v) : O[Xt] = (P.xPercent || P.yPercent ? "translate(" + P.xPercent + "%," + P.yPercent + "%) matrix(" : "matrix(") + A + ",0,0," + C + "," + M + "," + F + ")"; else {
                    if (j && (A < (d = 1e-4) && -d < A && (A = D = 2e-5), C < d && -d < C && (C = D = 2e-5), !I || P.z || P.rotationX || P.rotationY || (I = 0)), S || L) S *= Q, m = i = Math.cos(S), g = n = Math.sin(S), L && (S -= L * Q, m = Math.cos(S), g = Math.sin(S), "simple" === P.skewType && (e = Math.tan((L - N) * Q), m *= e = Math.sqrt(1 + e * e), g *= e, P.skewY && (e = Math.tan(N * Q), i *= e = Math.sqrt(1 + e * e), n *= e))), s = -g, a = m; else {
        ...
        (t = Yt.prototype).x = t.y = t.z = t.skewX = t.skewY = t.rotation = t.rotationX = t.rotationY = t.zOrigin = t.xPercent = t.yPercent = t.xOffset = t.yOffset = 0, t.scaleX = t.scaleY = t.scaleZ = 1, St("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", {
            parser: function (t, e, i, s, r, n, a) {
                ...
                if (P.skewType = x.skewType || P.skewType || Y.defaultSkewType, s._transform = P, O && "string" == typeof O && Xt) (_ = et.style)[Xt] = O, _.display = "block", _.position = "absolute", tt.body.appendChild(et), h = Ht(et, null, !1), "simple" === P.skewType && (h.scaleY *= Math.cos(h.skewX * Q)), P.svg && (p = P.xOrigin, d = P.yOrigin, h.x -= P.xOffset, h.y -= P.yOffset, (x.transformOrigin || x.svgOrigin) && (O = {}, At(t, pt(x.transformOrigin), O, x.svgOrigin, x.smoothOrigin, !0), p = O.xOrigin, d = O.yOrigin, h.x -= O.xOffset - P.xOffset, h.y -= O.yOffset - P.yOffset), (p || d) && (m = Zt(et, !0), h.x -= p - (p * m[0] + d * m[2]), h.y -= d - (p * m[1] + d * m[3]))), tt.body.removeChild(et), h.perspective || (h.perspective = P.perspective), null != x.xPercent && (h.xPercent = R(x.xPercent, P.xPercent)), null != x.yPercent && (h.yPercent = R(x.yPercent, P.yPercent)); else if ("object" == typeof x) {
                    ...
                    }, null != (c = x.directionalRotation)) if ("object" == typeof c) for (_ in c) x[_] = c[_]; else x.rotation = c;
            ...
            defaultValue: "0px", parser: function (t, e, i, s, r, n) {
                e = this.format(e);
            ...
            defaultValue: "0 0", parser: function (t, e, i, s, r, n) {
                var a, o, l, h, _, u, f = "background-position", c = S || lt(t, null),
            ...
            defaultValue: "0px solid #000", parser: function (t, e, i, s, r, n) {
                var a = ht(t, "borderTopWidth", S, !1, "0px"), o = this.format(e).split(" "), l = o[0].replace(X, "");
        ...
        function Qt(t) {
            var e, i = this.t, s = i.filter || ht(this.data, "filter") || "", r = this.s + this.c * t | 0;
        ...
        St("opacity,alpha,autoAlpha", {
            defaultValue: "1", parser: function (t, e, i, s, r, n) {
        ...
        St("className", {
            parser: function (t, e, i, s, r, n, a) {
                var o, l, h, _, u, f = t.getAttribute("class") || "", c = t.style.cssText;
        ...
        function te(t) {
            if ((1 === t || 0 === t) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                var e, i, s, r, n, a = this.t.style, o = m.transform.parse;
                if ("all" === this.e) r = !(a.cssText = ""); else for (s = (e = this.e.split(" ").join("").split(",")).length; -1 < --s;) i = e[s], m[i] && (m[i].parse === o ? r = !0 : i = "transformOrigin" === i ? Lt : m[i].p), Jt(a, i);
        ...
        (t = Y.prototype)._firstPT = t._lastParsedTransform = t._transform = null, t._onInitTween = function (t, e, i, s) {
            ...
            for (r in e) {
                if ("function" == typeof (h = e[r]) && (h = h(F, M)), n = m[r]) i = n.parse(t, h, r, this, i, s, e); else {
                    if ("--" === r.substr(0, 2)) {
        ...
        var ie = function (t, e, i) {
            var s, r, n, a;
            if (t.slice) for (r = t.length; -1 < --r;) ie(t[r], e, i); else for (r = (s = t.childNodes).length; -1 < --r;) a = (n = s[r]).type, n.style && (e.push(y(n)), i && i.push(n)), 1 !== a && 9 !== a && 11 !== a || !n.childNodes.length || ie(n, e, i)
        };
        return Y.cascadeTo = function (t, e, i) {
            var s, r, n, a, o = B.to(t, e, i), l = [o], h = [], _ = [], u = [], f = B._internals.reservedProps;
            for (t = o._targets || o.target, ie(t, h, u), o.render(e, !0, !0), ie(t, _), o.render(0, !0, !0), o._enabled(!0), s = u.length; -1 < --s;) if ((r = v(u[s], h[s], _[s])).firstMPT) {
        ...
        for (n = r.length; -1 < --n;) for (t = r[n], e = s._firstPT; e;) i = e._next, e.pg ? e.t._mod(a) : e.n === t && (2 === e.f && e.t ? l(e.t._firstPT) : (this._add(e.t, t, e.s, e.c), i && (i._prev = e._prev), e._prev ? e._prev._next = i : s._firstPT === e && (s._firstPT = i), e._next = e._prev = null, s._propLookup[t] = o)), e = i;
        return !1
        ...
        var s, r, n, a = _gsScope.GreenSockGlobals || _gsScope, o = a.com.greensock, l = 2 * Math.PI, h = Math.PI / 2,
            _ = o._class, u = m.register || function () {
    ...
    "use strict";
    var e, i, p = {}, s = f.document, d = f.GreenSockGlobals = f.GreenSockGlobals || f;
    if (!d.TweenLite) {
        var t, r, n, m, g, y = function (t) {
            var e, i = t.split("."), s = d;
            for (e = 0; e < i.length; e++) s[i[e]] = s = s[i[e]] || {};
            return s
        }, u = y("com.greensock"), v = 1e-10, l = function (t) {
            var e, i = [], s = t.length;
            for (e = 0; e !== s; i.push(t[e++])) ;
            return i
        }, T = function () {
            ...
            this.check = function (t) {
                ...
                if (0 === a && h) {
                    if (s = (i = ("com.greensock." + o).split(".")).pop(), r = y(i.join("."))[s] = this.gsClass = h.apply(h, u), _) if (d[s] = p[s] = r, "undefined" != typeof module && module.exports) if (o === c) for (n in module.exports = p[c] = r, p) r[n] = p[n]; else p[c] && (p[c][s] = r); else "function" == typeof define && define.amd && define((f.GreenSockAMDPath ? f.GreenSockAMDPath + "/" : "") + o.split(".").pop(), [], function () {
                        return r
                    });
        ...
        a.globals = d;
        var o = [0, 0, 1, 1], O = P("easing.Ease", function (t, e, i, s) {
            this._func = t, this._type = i || 0, this._power = s || 0, this._params = e ? o.concat(e) : o
        }, !0), S = O.map = {}, h = O.register = function (t, e, i, s) {
            for (var r, n, a, o, l = e.split(","), h = l.length, _ = (i || "easeIn,easeOut,easeInOut").split(","); -1 < --h;) for (n = l[h], r = s ? P("easing." + n, null, !0) : u.easing[n] || {}, a = _.length; -1 < --a;) o = _[a], S[n + "." + o] = S[o + n] = r[o] = t.getRatio ? t : t[o] || new t
        };
        ...
        var R = f.requestAnimationFrame, A = f.cancelAnimationFrame, C = Date.now || function () {
        ...
        P("Ticker", function (t, e) {
            var r, n, a, o, l, h = this, _ = C(), i = !(!1 === e || !R) && "auto", u = 500, f = 33, c = function (t) {
                var e, i, s = C() - D;
        ...
        M(), n.play = function (t, e) {
            ...
            if (this._timeline) {
                if (t < 0 && !i && (t += this.totalDuration()), this._timeline.smoothChildTiming) {
                    ...
                    if (s < t && !i && (t = s), this._startTime = (this._paused ? this._pauseTime : r._time) - (this._reversed ? s - t : t) / this._timeScale, r._dirty || this._uncache(!1), r._timeline) for (; r._timeline;) r._timeline._time !== (r._startTime + r._totalTime) / r._timeScale && r.totalTime(r._totalTime, !0), r = r._timeline
                }
        ...
        var I = [], X = {}, N = /(?:(-|-=|\+=)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi, L = /[\+-]=-?[\.\d]/,
            ...
            }, U = z._internals = {isArray: x, isSelector: E, lazyTweens: I, blobDif: Y}, V = z._plugins = {},
            q = U.tweenLookup = {}, W = 0, G = U.reservedProps = {
                ease: 1,
                delay: 1,
                overwrite: 1,
                onComplete: 1,
            ...
            H = _._rootFramesTimeline = new F, $ = _._rootTimeline = new F, Q = 30, K = U.lazyRender = function () {
                var t, e = I.length;
        ...
        var J = function (t, e, i) {
            ...
            var h, _ = e._startTime + v, u = [], f = 0, c = 0 === e._duration;
            ...
            for (n = f; -1 < --n;) if (o = u[n], 2 === s && o._kill(i, t, e) && (a = !0), 2 !== s || !o._firstPT && o._initted) {
        ...
        n._init = function () {
            ...
            if (a.startAt) {
                ...
                if (r.data = "isStart", r.overwrite = !1, r.immediateRender = !0, r.lazy = h && !1 !== a.lazy, r.startAt = r.delay = null, r.onUpdate = a.onUpdate, r.onUpdateParams = a.onUpdateParams, r.onUpdateScope = a.onUpdateScope || a.callbackScope || this, this._startAt = z.to(this.target, 0, r), h) if (0 < this._time) this._startAt = null; else if (0 !== l) return
            ...
            if (this._ease = _ = _ ? _ instanceof O ? _ : "function" == typeof _ ? new O(_, a.easeParams) : S[_] || z.defaultEase : z.defaultEase, a.easeParams instanceof Array && _.config && (this._ease = _.config.apply(_, a.easeParams)), this._easeType = this._ease._type, this._easePower = this._ease._power, this._firstPT = null, this._targets) for (n = this._targets.length, t = 0; t < n; t++) this._initProps(this._targets[t], this._propLookup[t] = {}, this._siblings[t], o ? o[t] : null, t) && (e = !0); else e = this._initProps(this.target, this._propLookup, this._siblings, o, 0);
            ...
            for (n in X[t._gsTweenID] && K(), this.vars.css || t.style && t !== f && t.nodeType && V.css && !1 !== this.vars.autoCSS && function (t, e) {
                ...
                t.css = s
            }(this.vars, t), this.vars) if (_ = this.vars[n], G[n]) _ && (_ instanceof Array || _.push && x(_)) && -1 !== _.join("").indexOf("{self}") && (this.vars[n] = _ = this._swapSelfInParams(_, this)); else if (V[n] && (l = new V[n])._onInitTween(t, this.vars[n], this, r)) {
                for (this._firstPT = h = {
                    _next: this._firstPT,
                    t: l,
                    p: "setRatio",
            ...
            if (l - 1e-7 <= t && 0 <= t) this._totalTime = this._time = l, this.ratio = this._ease._calcEnd ? this._ease.getRatio(1) : 1, this._reversed || (s = !0, r = "onComplete", i = i || this._timeline.autoRemoveChildren), 0 !== l || !this._initted && this.vars.lazy && !i || (this._startTime === this._timeline._duration && (t = 0), (h < 0 || t <= 0 && -1e-7 <= t || h === v && "isPause" !== this.data) && h !== t && (i = !0, v < h && (r = "onReverseComplete")), this._rawPrevTime = a = !e || t || h === t ? t : v); else if (t < 1e-7) this._totalTime = this._time = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0, (0 !== o || 0 === l && 0 < h) && (r = "onReverseComplete", s = this._reversed), t < 0 && (this._active = !1, 0 !== l || !this._initted && this.vars.lazy && !i || (0 <= h && (h !== v || "isPause" !== this.data) && (i = !0), this._rawPrevTime = a = !e || t || h === t ? t : v)), (!this._initted || this._startAt && this._startAt.progress()) && (i = !0); else if (this._totalTime = this._time = t, this._easeType) {
            ...
            if ((x(e) || E(e)) && "number" != typeof e[0]) for (s = e.length; -1 < --s;) this._kill(t, e[s], i) && (l = !0); else {
                if (this._targets) {
            ...
            if (g || m.wake(), t && this._gc) {
                ...
                if (s) for (i = s.length; -1 < --i;) this._siblings[i] = J(s[i], this, !0); else this._siblings = J(this.target, this, !0)
            }
            ...
            } else if (t._gsTweenID) for (i = (s = J(t).concat()).length; -1 < --i;) (s[i]._gc || e && !s[i].isActive()) && s.splice(i, 1);
            return s || []
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
    ...
    function x(e, t, r, n, o, i, a, s, l) {
        if (e !== s || t !== l) {
            ...
            var h = o % 360 * Q, u = Math.cos(h), c = Math.sin(h), f = (e - s) / 2, g = (t - l) / 2, p = u * f + c * g,
                d = -c * f + u * g, v = r * r, b = n * n, M = p * p, m = d * d, A = M / v + m / b;
            1 < A && (v = (r = Math.sqrt(A) * r) * r, b = (n = Math.sqrt(A) * n) * n);
            var y = i === a ? -1 : 1, x = (v * b - v * m - b * M) / (v * m + b * M);
            x < 0 && (x = 0);
            var N = y * Math.sqrt(x), S = r * d / n * N, z = -n * p / r * N, _ = u * S - c * z + (e + s) / 2,
                P = c * S + u * z + (t + l) / 2, w = (p - S) / r, T = (d - z) / n, L = (-p - S) / r, q = (-d - z) / n,
                G = Math.sqrt(w * w + T * T), I = w, Y = (y = T < 0 ? -1 : 1) * Math.acos(I / G) * E;
            ...
            var C, X, R, V = function (e, t) {
                var r, n, o, i, a, s, l = Math.ceil(Math.abs(t) / 90), h = 0, u = [];
                ...
                return u
            }(Y %= 360, B %= 360), F = u * r, j = c * r, H = c * -n, O = u * n, D = V.length - 2;
    ...
    function f(e) {
        ...
        }).match(I) || [], d = [], v = 0, b = 0, M = p.length, m = 2, A = 0;
        if (!e || !isNaN(p[0]) || isNaN(p[1])) return y("ERROR: malformed path data: " + e), d;
        for (t = 0; t < M; t++) if (g = i, isNaN(p[t]) ? a = (i = p[t].toUpperCase()) !== p[t] : t--, n = +p[t + 1], o = +p[t + 2], a && (n += v, o += b), 0 === t && (l = n, h = o), "M" === i) s && s.length < 8 && (d.length -= 1, m = 0), v = l = n, b = h = o, s = [n, o], A += m, m = 2, d.push(s), t += 2, i = "L"; else if ("C" === i) s || (s = [0, 0]), s[m++] = n, s[m++] = o, a || (v = b = 0), s[m++] = v + 1 * p[t + 3], s[m++] = b + 1 * p[t + 4], s[m++] = v += 1 * p[t + 5], s[m++] = b += 1 * p[t + 6], t += 6; else if ("S" === i) "C" === g || "S" === g ? (u = v - s[m - 4], c = b - s[m - 3], s[m++] = v + u, s[m++] = b + c) : (s[m++] = v, s[m++] = b), s[m++] = n, s[m++] = o, a || (v = b = 0), s[m++] = v += 1 * p[t + 3], s[m++] = b += 1 * p[t + 4], t += 4; else if ("Q" === i) u = n - v, c = o - b, s[m++] = v + 2 * u / 3, s[m++] = b + 2 * c / 3, a || (v = b = 0), u = n - (v += 1 * p[t + 3]), c = o - (b += 1 * p[t + 4]), s[m++] = v + 2 * u / 3, s[m++] = b + 2 * c / 3, s[m++] = v, s[m++] = b, t += 4; else if ("T" === i) u = v - s[m - 4], c = b - s[m - 3], s[m++] = v + u, s[m++] = b + c, u = v + 1.5 * u - n, c = b + 1.5 * c - o, s[m++] = n + 2 * u / 3, s[m++] = o + 2 * c / 3, s[m++] = v = n, s[m++] = b = o, t += 2; else if ("H" === i) o = b, s[m++] = v + (n - v) / 3, s[m++] = b + (o - b) / 3, s[m++] = v + 2 * (n - v) / 3, s[m++] = b + 2 * (o - b) / 3, s[m++] = v = n, s[m++] = o, t += 1; else if ("V" === i) o = n, n = v, a && (o += b - v), s[m++] = n, s[m++] = b + (o - b) / 3, s[m++] = n, s[m++] = b + 2 * (o - b) / 3, s[m++] = n, s[m++] = b = o, t += 1; else if ("L" === i || "Z" === i) "Z" === i && (n = l, o = h, s.closed = !0), ("L" === i || .5 < Math.abs(v - n) || .5 < Math.abs(b - o)) && (s[m++] = v + (n - v) / 3, s[m++] = b + (o - b) / 3, s[m++] = v + 2 * (n - v) / 3, s[m++] = b + 2 * (o - b) / 3, s[m++] = n, s[m++] = o, "L" === i && (t += 2)), v = n, b = o; else if ("A" === i) {
    ...
    function N(e, t) {
        var r, n, o, i, a, s, l, h, u, c, f, g, p, d, v = 0, b = e.length, M = t / ((b - 2) / 6);
        for (p = 2; p < b; p += 6) for (v += M; .999999 < v;) r = e[p - 2], n = e[p - 1], o = e[p], i = e[p + 1], a = e[p + 2], s = e[p + 3], l = e[p + 4], h = e[p + 5], u = r + (o - r) * (d = 1 / (Math.floor(v) + 1)), u += ((f = o + (a - o) * d) - u) * d, f += (a + (l - a) * d - f) * d, c = n + (i - n) * d, c += ((g = i + (s - i) * d) - c) * d, g += (s + (h - s) * d - g) * d, e.splice(p, 4, r + (o - r) * d, n + (i - n) * d, u, c, u + (f - u) * d, c + (g - c) * d, f, g, a + (l - a) * d, s + (h - s) * d), p += 6, b += 6, v--;
        return e
    }
    ...
    function z(e) {
        var t, r, n, o = e.length, i = e[0], a = i, s = e[1], l = s;
        for (n = 6; n < o; n += 6) i < (t = e[n]) ? i = t : t < a && (a = t), s < (r = e[n + 1]) ? s = r : r < l && (l = r);
        return e.centerX = (i + a) / 2, e.centerY = (s + l) / 2, e.size = (i - a) * (s - l)
    }

    function _(e) {
        for (var t, r, n, o, i, a = e.length, s = e[0][0], l = s, h = e[0][1], u = h; -1 < --a;) for (t = (i = e[a]).length, o = 6; o < t; o += 6) s < (r = i[o]) ? s = r : r < l && (l = r), h < (n = i[o + 1]) ? h = n : n < u && (u = n);
    ...
    function p(e, t, r, n, o) {
        var i, a, s, l, h = e.length, u = 0, c = h - 2;
        for (r *= 6, a = 0; a < h; a += 6) l = e[i = (a + r) % c] - (t[a] - n), s = e[1 + i] - (t[a + 1] - o), u += Math.sqrt(s * s + l * l);
        return u
    }

    function L(e, t, r) {
        var n, o, i, a = e.length, s = g(e), l = g(t), h = l[0] - s[0], u = l[1] - s[1], c = p(e, t, 0, h, u), f = 0;
        for (i = 6; i < a; i += 6) (o = p(e, t, i / 6, h, u)) < c && (c = o, f = i);
        if (r) for (n = e.slice(0), S(n), i = 6; i < a; i += 6) (o = p(n, t, i / 6, h, u)) < c && (c = o, f = -i);
        return f / 6
    }

    function q(e, t, r) {
        for (var n, o, i, a, s, l, h = e.length, u = 99999999999, c = 0, f = 0; -1 < --h;) for (l = (n = e[h]).length, s = 0; s < l; s += 6) o = n[s] - t, i = n[s + 1] - r, (a = Math.sqrt(o * o + i * i)) < u && (u = a, c = n[s], f = n[s + 1]);
        return [c, f]
    }

    function G(e, t, r, n, o, i) {
        var a, s, l, h, u = t.length, c = 0, f = Math.min(e.size || z(e), t[r].size || z(t[r])) * n, g = 999999999999,
    ...
    function s(e, t, r, n) {
        var o, i, a, s, l, h, u, c = t.length - e.length, f = 0 < c ? t : e, g = 0 < c ? e : t, p = 0,
            d = "complexity" === n ? P : w, v = "position" === n ? 0 : "number" == typeof n ? n : .8, b = g.length,
            M = "object" == typeof r && r.push ? r.slice(0) : [r], m = "reverse" === M[0] || M[0] < 0, A = "log" === r;
        if (g[0]) {
            if (1 < f.length && (e.sort(d), t.sort(d), h = f.size || _(f), h = g.size || _(g), h = f.centerX - g.centerX, u = f.centerY - g.centerY, d === w)) for (b = 0; b < g.length; b++) f.splice(b, 0, G(g[b], f, b, v, h, u));
            if (c) for (c < 0 && (c = -c), f[0].length > g[0].length && N(g[0], (f[0].length - g[0].length) / 6 | 0), b = g.length; p < c;) f[b].size || z(f[b]), s = (a = q(g, f[b].centerX, f[b].centerY))[0], l = a[1], g[b++] = [s, l, s, l, s, l, s, l], g.totalPoints += 8, p++;
    ...
    function o(e, t) {
        var r, n, o, i, a, s, l, h = 0, u = parseFloat(e[0]), c = parseFloat(e[1]), f = u + "," + c + " ";
        for (r = .5 * t / (.5 * (o = e.length) - 1), n = 0; n < o - 2; n += 2) {
            if (h += r, s = parseFloat(e[n + 2]), l = parseFloat(e[n + 3]), .999999 < h) for (a = 1 / (Math.floor(h) + 1), i = 1; .999999 < h;) f += (u + (s - u) * a * i).toFixed(2) + "," + (c + (l - c) * a * i).toFixed(2) + " ", h--, i++;
            f += s + "," + l + " ", u = s, c = l
        }
        return f
    }
    ...
    function r(e) {
        var t = e[0].match(Y) || [], r = e[1].match(Y) || [], n = r.length - t.length;
    ...
    function u(t) {
        return isNaN(t) ? r : function (e) {
            r(e), e[1] = function (e, t) {
                if (!t) return e;
                var r, n, o, i = e.match(Y) || [], a = i.length, s = "";
    ...
    function l(e, t) {
        ...
        return "path" !== N && e.getBBox ? (s = function (e, t) {
            var r = document.createElementNS("http://www.w3.org/2000/svg", "path"),
                n = Array.prototype.slice.call(e.attributes), o = n.length;
    ...
    var Q = Math.PI / 180, E = 180 / Math.PI, I = /[achlmqstvz]|(-?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,
        Y = /(?:(-|-=|\+=)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi, c = /[achlmqstvz]/gi, B = /[\+\-]?\d*\.?\d+e[\+\-]?\d+/gi,
    ...
    M.pathFilter = h, M.pointsFilter = r, M.subdivideRawBezier = N, M.defaultMap = "size", M.pathDataToRawBezier = function (e) {
        ...
        var r, n, o, i, a, s, l, h, u = f(d(e, !0))[0] || [], c = 0;
        if (h = (t = t || {}).align || t.relative, i = t.matrix || [1, 0, 0, 1, 0, 0], a = t.offsetX || 0, s = t.offsetY || 0, "relative" === h || !0 === h ? (a -= u[0] * i[0] + u[1] * i[2], s -= u[0] * i[1] + u[1] * i[3], c = "+=") : (a += i[4], s += i[5], h && ((h = "string" == typeof h ? v.selector(h) : h && h[0] ? h : [h]) && h[0] && (a -= (l = h[0].getBBox() || {
            x: 0,
            y: 0
        }).x, s -= l.y))), r = [], o = u.length, i) for (n = 0; n < o; n += 2) r.push({
            x: c + (u[n] * i[0] + u[n + 1] * i[2] + a),
            y: c + (u[n] * i[1] + u[n + 1] * i[3] + s)
        }); else for (n = 0; n < o; n += 2) r.push({x: c + (u[n] + a), y: c + (u[n + 1] + s)});
        return r
    }
...
!function (i) {
    ...
    function a(e, t, i, n, s, r, l) {
        var o, d, p, a, h, u, f, c, g, y, x, _, v = F(e), b = $(e, "paddingLeft", v), S = -999,
            m = $(e, "borderBottomWidth", v) + $(e, "borderTopWidth", v),
            C = $(e, "borderLeftWidth", v) + $(e, "borderRightWidth", v),
            T = $(e, "paddingTop", v) + $(e, "paddingBottom", v), N = $(e, "paddingLeft", v) + $(e, "paddingRight", v),
            w = .2 * $(e, "fontSize"), A = $(e, "textAlign", v, !0), L = [], B = [], V = [], W = t.wordDelimiter || " ",
            H = t.span ? "span" : "div", E = t.type || t.split || "chars,words,lines",
            O = s && -1 !== E.indexOf("lines") ? [] : null, k = -1 !== E.indexOf("words"),
            R = -1 !== E.indexOf("chars"), j = "absolute" === t.position || !0 === t.absolute, M = t.linesClass,
            G = -1 !== (M || "").indexOf("++");
        ...
        if (O || j) for (o = 0; o < p; o++) ((u = (a = h[o]).parentNode === e) || j || R && !k) && (_ = a.offsetTop, O && u && Math.abs(_ - S) > w && "BR" !== a.nodeName && (f = [], O.push(f), S = _), j && (a._x = a.offsetLeft, a._y = _, a._w = a.offsetWidth, a._h = a.offsetHeight), O && ((a._isSplit && u || !R && u || k && u || !k && a.parentNode.parentNode === e && !a.parentNode._isSplit) && (f.push(a), a._x -= b, z(a, e, W) && (a._wordEnd = !0)), "BR" === a.nodeName && a.nextSibling && "BR" === a.nextSibling.nodeName && O.push([])));
    ...
    var s = i.GreenSockGlobals || i, e = function (e) {
            var t, i = e.split("."), n = s;
            for (t = 0; t < i.length; t++) n[i[t]] = n = n[i[t]] || {};
            return n
        }("com.greensock.utils"), T = function (e) {
            var t = e.nodeType, i = "";
            if (1 === t || 9 === t || 11 === t) {
            ...
            return i
        }, D = document, F = D.defaultView ? D.defaultView.getComputedStyle : function () {
        }, r = /([A-Z])/g, N = /(?:\r|\n|\t\t)/g, w = /(?:\s\s+)/g, A = 127462, L = 127487,
        ...
        n = e.SplitText = s.SplitText = function (e, t) {
            ...
            this.elements = l(e) ? function (e) {
                ...
                for (t = 0; t < r; t++) if (i = e[t], l(i)) for (n = i.length, n = 0; n < i.length; n++) s.push(i[n]); else s.push(i);
                return s
            }(e) : [e], this.chars = [], this.words = [], this.lines = [], this._originals = [], this.vars = t || {}, this.split(t)
        }, I = function (e, t, i) {
            var n = e.nodeType;
            if (1 === n || 9 === n || 11 === n) for (e = e.firstChild; e; e = e.nextSibling) I(e, t, i); else 3 !== n && 4 !== n || (e.nodeValue = e.nodeValue.split(t).join(i))
        }, P = function (e) {
            var t, i, n = p(e.childNodes), s = n.length;
            ...
            var s, r, l = p(e.childNodes), o = l.length, d = "absolute" === t.position || !0 === t.absolute;
            if (3 !== e.nodeType || 1 < o) {
            ...
            !function (e, t, i, n) {
                var s, r, l, o, d, p, a, h, u, f = t.span ? "span" : "div", c = t.type || t.split || "chars,words,lines",
                    g = (c.indexOf("words"), -1 !== c.indexOf("chars")), y = "absolute" === t.position || !0 === t.absolute,
                    x = t.wordDelimiter || " ", _ = " " !== x ? "" : y ? "&#173; " : " ", v = t.span ? "</span>" : "</div>",
                    b = !0, S = D.createElement("div"), m = e.parentNode;
                for (m.insertBefore(S, e), S.textContent = e.nodeValue, m.removeChild(e), a = -1 !== (s = T(e = S)).indexOf("<"), !1 !== t.reduceWhiteSpace && (s = s.replace(w, " ").replace(N, "")), a && (s = s.split("<").join("{{LT}}")), d = s.length, r = (" " === s.charAt(0) ? _ : "") + i(), l = 0; l < d; l++) if ((p = s.charAt(l)) === x && s.charAt(l - 1) !== x && l) {
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
    ...
    _gsScope._gsDefine("easing.CustomEase", ["easing.Ease"], function (m) {
        ...
        var x = /(?:(-|-=|\+=)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,
            S = /[achlmqstvz]|(-?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi, w = /[\+\-]?\d*\.?\d+e[\+\-]?\d+/gi, d = /[cLlsS]/g,
            _ = "CustomEase only accepts Cubic Bezier data.", D = function (e, t, i, n, o, s, a, r, u, c, h) {
                var f, l = (e + i) / 2, g = (t + n) / 2, p = (i + o) / 2, x = (n + s) / 2, d = (o + a) / 2, y = (s + r) / 2,
                    m = (l + p) / 2, S = (g + x) / 2, w = (p + d) / 2, _ = (x + y) / 2, b = (m + w) / 2, v = (S + _) / 2,
                    M = a - e, k = r - t, C = Math.abs((i - a) * k - (n - r) * M), z = Math.abs((o - a) * k - (s - r) * M);
        ...
        return e.constructor = o, e.setData = function (e, t) {
            var i, n, o, s, a, r, u, c, h, f, l = (e = e || "0,0,1,1").match(x), g = 1, p = [];
            if (f = (t = t || {}).precision || 1, this.data = e, this.lookup = [], this.points = p, this.fast = f <= 1, (d.test(e) || -1 !== e.indexOf("M") && -1 === e.indexOf("C")) && (l = function (e) {
                var t, i, n, o, s, a, r, u, c, h, f, l = (e + "").replace(w, function (e) {
                    var t = +e;
                    return t < 1e-4 && -1e-4 < t ? 0 : t
                }).match(S) || [], g = [], p = 0, x = 0, d = l.length, y = 2;
                for (t = 0; t < d; t++) if (c = o, isNaN(l[t]) ? s = (o = l[t].toUpperCase()) !== l[t] : t--, i = +l[t + 1], n = +l[t + 2], s && (i += p, n += x), t || (r = i, u = n), "M" === o) a && a.length < 8 && (g.length -= 1, y = 0), p = r = i, x = u = n, a = [i, n], y = 2, g.push(a), t += 2, o = "L"; else if ("C" === o) a || (a = [0, 0]), a[y++] = i, a[y++] = n, s || (p = x = 0), a[y++] = p + 1 * l[t + 3], a[y++] = x + 1 * l[t + 4], a[y++] = p += 1 * l[t + 5], a[y++] = x += 1 * l[t + 6], t += 6; else if ("S" === o) "C" === c || "S" === c ? (h = p - a[y - 4], f = x - a[y - 3], a[y++] = p + h, a[y++] = x + f) : (a[y++] = p, a[y++] = x), a[y++] = i, a[y++] = n, s || (p = x = 0), a[y++] = p += 1 * l[t + 3], a[y++] = x += 1 * l[t + 4], t += 4; else {
                    if ("L" !== o && "Z" !== o) throw _;
                ...
                return g[0]
            }(e)), 4 === (i = l.length)) l.unshift(0, 0), l.push(1, 1), i = 8; else if ((i - 2) % 6) throw _;
            for (0 == +l[0] && 1 == +l[i - 2] || function (e, t, i) {
                i || 0 === i || (i = Math.max(+e[e.length - 1], +e[1]));
                var n, o = -1 * +e[0], s = -i, a = e.length, r = 1 / (+e[a - 2] + o),
                    u = -t || (Math.abs(+e[a - 1] - +e[1]) < .01 * (+e[a - 2] - +e[0]) ? function (e) {
                        var t, i = e.length, n = 999999999999;
            ...
            } else for (s = 0; s < i; s++) u.nx < s * a && (u = p[++r]), this.lookup[s] = u;
            return this
            ...
            var i, n, o, s, a, r, u, c, h, f, l = 1e3, g = (t = t || {}).width || 100, p = t.height || 100,
                x = t.x || 0, d = (t.y || 0) + p, y = t.path;
            if (t.invert && (p = -p, d = 0), (e = e.getRatio ? e : m.map[e] || console.log("No ease found: ", e)).rawBezier) {
                ...
                i[0] = "M" + i[0], i[1] = "C" + i[1]
            } else for (i = ["M" + x + "," + d], s = 1 / (u = Math.max(5, 200 * (t.precision || 1))), c = 5 / (u += 2), h = ((x + s * g) * l | 0) / l, n = ((f = ((d + e.getRatio(s) * -p) * l | 0) / l) - d) / (h - x), o = 2; o < u; o++) a = ((x + o * s * g) * l | 0) / l, r = ((d + e.getRatio(o * s) * -p) * l | 0) / l, (Math.abs((r - f) / (a - h) - n) > c || o === u - 1) && (i.push(h + "," + f), n = (r - f) / (a - h)), h = a, f = r;
...
!function (p, d, c) {
    ...
    function y(e, n, t, r) {
        var o, i, s, a, l = "modernizr", f = m("div"), u = function () {
            var e = d.body;
            return e || ((e = m(b ? "svg" : "body")).fake = !0), e
        }();
        if (parseInt(t, 10)) for (; t--;) (s = m("div")).id = r ? r[t] : l + (t + 1), f.appendChild(s);
    ...
    function l(e, n, t, r) {
        ...
        if (r = !v(r, "undefined") && r, !v(t, "undefined")) {
            var i = function (e, n) {
                ...
                if ("CSS" in p && "supports" in p.CSS) {
                    for (; t--;) if (p.CSS.supports(g(e[t]), n)) return !0;
                    return !1
                }
        ...
        for (l = e.length, a = 0; a < l; a++) if (f = e[a], u = _.style[f], !~("" + f).indexOf("-") || (f = h(f)), _.style[f] !== c) {
    ...
    function r(e, n, t, r, o) {
        ...
        return v(n, "string") || v(n, "undefined") ? l(s, n, r, o) : function (e, n, t) {
            var r;
            for (var o in e) if (e[o] in n) return !1 === t ? e[o] : v(r = n[e[o]], "function") ? a(r, t || n) : r;
            return !1
    ...
    var x = d.documentElement, b = "svg" === x.nodeName.toLowerCase();
    C.addTest("placeholder", "placeholder" in m("input") && "placeholder" in m("textarea"));
    var t = "Moz O ms Webkit", w = n._config.usePrefixes ? t.split(" ") : [];
    n._cssomPrefixes = w;

    function o(e) {
        var n, t = prefixes.length, r = p.CSSRule;
    ...
    }), C.addTest("bgsizecover", e("backgroundSize", "cover")), function () {
        var e, n, t, r, o, i;
        for (var s in u) if (u.hasOwnProperty(s)) {
            if (e = [], (n = u[s]).name && (e.push(n.name.toLowerCase()), n.options && n.options.aliases && n.options.aliases.length)) for (t = 0; t < n.options.aliases.length; t++) e.push(n.options.aliases[t].toLowerCase());
...
!function (c, w, x) {
    ...
    function t(e) {
        if (S = w.documentElement, n = w.body, G(), re = this, le = (e = e || {}).constants || {}, e.easing) for (var t in e.easing) Y[t] = e.easing[t];
    ...
    var S, n, A = {
        ...
        }, F = Object.prototype.hasOwnProperty, k = c.Math, o = c.getComputedStyle, C = "touchstart", H = "touchmove",
        D = "touchcancel", I = "touchend", P = "skrollable", N = P + "-before", O = P + "-between", V = P + "-after",
        a = "skrollr", i = "no-" + a, l = a + "-desktop", s = a + "-mobile", f = "linear", u = .004, m = "skrollr-body",
        p = 200, d = "center", g = "bottom", z = "___skrollable_id", q = /^(?:input|textarea|button|select)$/i,
        r = /^\s+|\s+$/g,
        L = /^data(?:-(_\w+))?(?:-?(-?\d*\.?\d+p?))?(?:-?(start|end|top|center|bottom))?(?:-?(top|center|bottom))?$/,
        v = /\s*(@?[\w\-\[\]]+)\s*:\s*(.+?)\s*(?:;|$)/gi, h = /^(@?[a-z\-]+)\[(\w+)\]$/, M = /-([a-z0-9_])/g,
        y = /[\-+]?[\d]*\.?[\d]+/g, T = /\{\?\}/g, b = /rgba?\(\s*-?\d+\s*,\s*-?\d+\s*,\s*-?\d+/g,
        $ = /[a-z\-]+-gradient/g, B = "", _ = "", G = function () {
            ...
            var e = c.requestAnimationFrame || c[B.toLowerCase() + "RequestAnimationFrame"], n = Ce();
            return !Me && e || (e = function (e) {
                var t = Ce() - n, r = k.max(0, 1e3 / 60 - t);
    ...
    var R = function () {
        ...
        he(S, [C, H, D, I].join(" "), function (e) {
            ...
            switch (d = t.clientY, g = t.clientX, y = e.timeStamp, q.test(p.tagName) || e.preventDefault(), e.type) {
                ...
                case I:
                    ...
                    var a = h / b;
                    a = k.max(k.min(a, 3), -3);
                    var i = k.abs(a / se), l = a * i + .5 * se * i * i, s = re.getScrollTop() - l, c = 0;
        ...
        qe && (qe = !1, Se());
        var e, t, r = re.getScrollTop(), n = Ce();
        if (ce) n >= ce.endTime ? (r = ce.targetTop, e = ce.done, ce = x) : (t = ce.easing((n - ce.startTime) / ce.duration), r = 0 | ce.startTop + t * ce.topDiff), re.setScrollTop(r, !0); else if (!pe) {
            me.targetTop - r && (me = {
                startTop: Ne,
                topDiff: r - Ne,
                targetTop: r,
        ...
        if (Me && oe && A.setStyle(oe, "transform", "translate(0, " + -$e + "px) " + ge), pe || Ne !== r) {
            ...
            (pe = !1) !== (ae.beforerender && ae.beforerender.call(re, o)) && (function (e, t) {
                for (var r = 0, n = ne.length; r < n; r++) {
                    var o, a, i = ne[r], l = i.element, s = i.smoothScrolling ? e : t, c = i.keyFrames, f = c.length,
                    ...
                    for (var T = 0; T < f - 1; T++) if (s >= c[T].frame && c[T + 1].frame >= s) {
                        var b = c[T], S = c[T + 1];
                        for (o in b.props) if (F.call(b.props, o)) {
        ...
        var e = o(oe), t = e.getPropertyValue("transform"), r = e.getPropertyValue(_ + "transform");
        t && "none" !== t || r && "none" !== r || (ge = "")
    };
    A.setStyle = function (e, t, r) {
        var n = e.style;
        if ("zIndex" === (t = t.replace(M, E).replace("-", ""))) n[t] = isNaN(r) ? r : "" + (0 | r); else if ("float" === t) n.styleFloat = n.cssFloat = r; else try {
    ...
    var re, ne, oe, ae, ie, le, se, ce, fe, ue, me, pe, de, ge, ve, he = A.addEvent = function (e, t, r) {
        ...
        De = 0, ie && !Me && (n.style.height = ""), function () {
            var e, t, r, n, o, a, i, l, s, c, f, u = S.clientHeight, m = ke();
            for (l = 0, s = ne.length; l < s; l++) for (t = (e = ne[l]).element, r = e.anchorTarget, o = 0, a = (n = e.keyFrames).length; o < a; o++) c = (i = n[o]).offset, f = m[i.constant] || 0, i.frame = c, i.isPercentage && (c *= u, i.frame = c), "relative" === i.mode && (ee(t), i.frame = re.relativeToAbsolute(r, i.anchors[0], i.anchors[1]) - c, ee(t, !0)), i.frame += f, ie && !i.isEnd && i.frame > De && (De = i.frame);
    ...
    }, De = 0, Ie = 1, Pe = "down", Ne = -1, Oe = Ce(), Ve = 0, ze = 0, qe = !1, Le = 0, Me = !1, $e = 0, Be = [];
...
var s, Main = {
    el: {
    ...
    }, vars: {window_w: 1e3, window_h: 1e3}, init: function () {
        var x = Main.el.window.width(), k = Main.el.window.height(), M = Main.el.body;
        ...
        jQuery(".general-content").length && {image: jQuery(".size-full")}.image.each(function () {
            var e = jQuery(this).parent()[0], a = jQuery(this).attr("width");
                ...
                jQuery(e).each(function () {
                    ...
                    if (0 <= a.top + a.height && a.bottom - a.height <= t) {
                        var r = jQuery(this).parent(), s = r.height(),
                            ...
                            l = Math.max(-window.innerHeight, o), n = Math.floor(Math.min(window.innerHeight, l), 2),
                            u = c(1, n * i, 1);
                        TweenMax.set(e, {y: u})
                    }
                })
        ...
        var i, n, u = new TimelineMax({paused: !0}), d = {
        ...
        if (u.staggerTo(d.fade, 1.2, {alpha: 1, ease: T.ease1}, .1, 0), u.to(d.fade2, 1.6, {
            ...
            var p = document.getElementById("home-video"), h = new TimelineMax({paused: !0, repeat: -1});
            ...
            if (jQuery(".intro-text-holder").length) {
                var y = jQuery(".intro-holder__titles"), g = new SplitText(y, {
                    type: "chars lines",
                    charsClass: "char char++",
                    linesClass: "text-line text-line-line++"
                }), j = (g.chars.slice(0), g.lines), f = new TimelineMax({delay: 1});
            ...
            if (document.getElementById("site-intro")) {
                var C = new TimelineMax({
                    reversed: !1, onReverseComplete: function () {
                        u.play(), h.play()
                    }
                }), b = jQuery("#home-link"), A = jQuery("#shop-link"), O = {
                ...
                var S = window.innerWidth / 2, E = window.innerHeight / 2, I = jQuery("#mouse")[0], B = "200 200",
                    ...
                    }), H = jQuery(".site-intro-link"), P = Y.$default.getBoundingClientRect().width;
                Y.$cursor.getBoundingClientRect();
                Svg = {
                    hoverState: function (e) {
                        var a = new TimelineMax, t = e.ref, r = e.scale, s = e.svgOrigin;
                        a.set(t.$default, {
                            fillOpacity: 1,
                            strokeOpacity: 1,
                            strokeWidth: 1,
                        ...
                        var a = new TimelineMax, t = e.ref, r = e.svgOrigin;
                        a.to(t.$default, .4, {
                            scale: 1,
                            svgOrigin: r,
        ...
        if (jQuery(".circle-link").hover(function () {
            var e = jQuery(this).find(".js-svg-circle"), a = jQuery(this).find(".js-stretched"),
            ...
            var R = {holder: jQuery("#marquee"), elements: jQuery(".js-marquee-element")}, V = R.holder, q = R.elements,
                W = q.clone(), G = 0;
            q.each(function (e) {
        ...
        if (M.hasClass("single-cpt_heritage")) {
            ...
            var ae = jQuery(".page-numbers"), te = jQuery(".js-bottom").outerHeight() + 100;
            jQuery(window).scroll(function () {
        ...
        if (M.hasClass("single-post")) {
            var re = jQuery(".post-nav__links"), se = jQuery(".js-bottom")[0].getBoundingClientRect(),
                oe = se.top - se.height;
            jQuery(window).scroll(function () {
        ...
        if (document.getElementById("heritage-intro")) {
            var ue = jQuery(".heritage-image"), ce = jQuery(".heritage-image-b"), de = jQuery(".heritage-image-c");
            TweenMax.set(ue, {transformStyle: "preserve-3d"}), TweenMax.set(ce, {transformStyle: "preserve-3d"}), TweenMax.set(de, {transformStyle: "preserve-3d"}), M.mousemove(function (e) {
                var a = e.pageX / M.width() * 100 - 50, t = e.pageY / M.height() * 100 - 50;
                TweenMax.to(ue, 1, {
                    rotationY: .05 * a,
                    rotationX: .2 * t,
                    rotationZ: "-0.1",
            ...
            pe.trigger.click(function (e) {
                e.preventDefault();
                var a = jQuery(this).attr("href"), t = new TimelineMax({
                    onComplete: function () {
                        window.location.href = a
                    }
                });
            ...
            var me = {
                ...
                reversed: !1, onComplete: function () {
            ...
            he.introLink.click(function () {
                ...
                jQuery.ajax({
                    ...
                    success: function (e) {
                        var a = (e = JSON.parse(e)).title, t = e.text, r = e.image, s = e.url, o = e.is_vertical,
                            i = jQuery("#heritage-title"), l = jQuery("#heritage-text"), n = jQuery("#heritage-image"),
                            u = jQuery("#heritage-image-b"), c = jQuery("#heritage-image-c"),
                        ...
                        if (he.link.removeClass("loc"), h.addClass("loc"), jQuery(he.introLink).hasClass("loc")) d.attr("href", s), i.empty(), i.append(a), l.empty(), l.append(t), n.empty(), u.empty(), c.empty(), 1 == o ? (n.append('<img src="' + r + '" alt="' + a + '" class="is-vertical">'), u.append('<img src="' + r + '" alt="' + a + '" class="is-vertical">'), c.append('<img src="' + r + '" alt="' + a + '" class="is-vertical">')) : (n.append('<img src="' + r + '" alt="' + a + '" class="block-image">'), u.append('<img src="' + r + '" alt="' + a + '" class="block-image">'), c.append('<img src="' + r + '" alt="' + a + '" class="block-image">')), he.introLink.removeClass("loc"), ye.reverse().timeScale(1.8), setTimeout(function () {
                            ...
                            var p = new TimelineMax({
                                paused: !0, reversed: !1, onComplete: function () {
        ...
        var ve = new TimelineMax({paused: !0}), Qe = {
        ...
        var we = jQuery("#ns-accept"), _e = jQuery(".ns-accept");
        we.on("click", function () {
            ...
            var e = jQuery(this).parents("form").attr("id"), a = jQuery(jQuery(this).data("reply"));
    ...
    alt="Minas Designs-mykonos_store_4" class="popup-slider__img  display--block m-auto">
        ...
        M.hasClass("loaded") && setTimeout(function () {
            ...
            a.to(Ie.bg, .8, {
                ...
                jQuery.ajax({
                    url: templateURL + "ajax_cookies_agree.php", type: "post", success: function (e) {
        ...
        Main.build_sliders(Be), s = skrollr.init({
            keyframe: function (e, a, t) {
                var r = new TimelineMax, s = jQuery(e), o = jQuery(e).data("delay"), i = jQuery(e).data("trans"),
                    l = jQuery(e).data("ease"), n = jQuery(e).data("cubic");
                        ...
                        onComplete: function () {
                            jQuery(window).on("scroll wheel DOMMouseScroll mousewheel", function (e) {
                                (0 < e.originalEvent.detail || e.originalEvent.wheelDelta < 0) && (d.text.length && c.to(m, 1.2, {
                                    ...
                                    var e = Main.el.window.width(), a = Main.el.window.height();
                ...
                if (s.hasClass("skrollr-pointer") && "dataBottomTop" == a && "down" == t) {
                    if (s.hasClass("curtain-vertical") && (l = null == n || "custom2" != n ? CustomEase.create("custom2", "M0,0 C0.49,0.05 0.18,0.94 1,1") : null == n || "custom" != n ? CustomEase.create("custom", "M0,0 C0.348,0.822 0.22,1 1,1") : Power1.easeInOut, r.to(e, i, {
                        ...
                        var y = s.data("alpha"), g = s.data("velocity");
                        o = s.data("delay");
                    ...
                    if (s.hasClass("js-fade-up") && r.to(jQuery(e), i, {
                        ...
                        }, f = jQuery(".number-digit > div").height(), v = ("" + j.year).split("");
                        j.firstDigit = v[0], j.secondDigit = v[1], j.thirdDigit = v[2], j.fourthDigit = v[3];
                        var Q = Math.abs(10 - j.firstDigit - 10), w = Math.abs(10 - j.secondDigit - 10),
                            _ = Math.abs(10 - j.thirdDigit - 10), C = Math.abs(10 - j.fourthDigit - 10);
        ...
        e.each(function () {
            var c = jQuery(this), e = c.attr("id");
            new TimelineMax;
            "popup-slider__holder" == e ? c.gsapSlider({
                slider_id: e, setCustomAnimation: function (e, a, t) {
                ...
                beforeChange: function (e, a, t, r) {
                    ...
                    if (document.getElementById("slider-main")) {
                        var o = e.find(".js-fade"), i = e.find(".js-tl-img");
                ...
                afterChange: function (e, a, t) {
                    ...
                    if (document.getElementById("slider-main")) {
                        ...
                        var o = 2 * Math.PI * 54 * (1 - s / 100), i = document.getElementById("precentage_slider");
                        TweenMax.to(i, 1.5, {strokeDashoffset: o, ease: "custom"});
                        var l = e.find(".js-fade"), n = e.find(".js-tl"), u = e.find(".js-tl-img");
